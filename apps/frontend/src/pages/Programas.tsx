...
import heroImage1 from "@/assets/lectura1.webp";
import heroImage2 from "@/assets/refuerzo1.webp";
import heroImage3 from "@/assets/voluntarios-2.webp";
    ...
    <main className="min-h-screen bg-hero pt-20">
      ...
      <section id="metodologia" className="min-h-screen flex items-center py-16 md:py-20 relative bg-brand-foreground/5">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(${heroImage3})`
          }}
        />
